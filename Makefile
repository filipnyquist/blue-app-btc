...
# Lbry
DEFINES += BTCHIP_P2PKH_VERSION=85 BTCHIP_P2SH_VERSION=122 BTCHIP_COIN_FAMILY=1 BTCHIP_COINID=\"Lbry\" COINID_UPCASE=\"LBRY\" COLOR_HDR=0xFCB653 COLOR_DB=0xFEDBA9 COINID_NAME=\"Lbry\" COINID=$(COIN) BTCHIP_COINID_SHORT=\"LBC\" COIN_SYSCOIN
APPNAME ="Lbry"
else
